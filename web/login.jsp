                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="signup-form">
                            <form class="mt-5 border p-4 bg-light shadow" action="generalcode/logincode.jsp" method="POST">
                                <h3 class="mb-4 text-secondary">Login Here</h3>
                                <div class="row">
                                    ...
                                    <div class=" col-md-12 ">
                                        <button type="submit" class="btn btn-success shadow ">Sign In</button>
                                    </div>

                                </div>
                            </form>
                            <p class="mt-2 text-center text-secondary">Not Registered yet? Register <a href="signup.jsp">Here</a></p>
                        </div>
                    </div>
                </div>
            </div>
